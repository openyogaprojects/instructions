...
### Шаг 9. Изменение прав на каталоги. Рестарт NGINX.
На новом сервере:
```
...
### Шаг 10. Изменение /etc/hosts и обновление moodle.
...
### Шаг 12. Изменение TXT и A записи DNS
...
### Шаг 13. Вывод сайта из режима обслуживания.

### Шаг 14. Копирование crontab.
...
### Шаг 15. Удаление crontab на старом сервере.
На старом сервере выполнить команду:
`crontab -e `
и удалить все содержимое.

### Шаг 16. Очистка /etc/hosts
...
### Шаг 18. Удаление старого сервера
